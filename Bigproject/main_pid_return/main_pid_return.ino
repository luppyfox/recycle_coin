...
void loop() {
  ...
  if (setz == 0) {
    ...
    while (setz == 2) {
      ...
      PIDControl(e, kp, max_pwm, min_pwm, tolerance);
      ...
      if (e == 0 && state == 1) {
        ...
        // int e = pos - pprToGoal(1);
        // PIDControl(e, 0.15, 200, 100, 0);
        ...
        // int e = pos - pprToGoal(1);
        // PIDControl(e + 100, 0.15, 200, 100, 0);
...
void PIDControl(int e, int kp, int max_pwm, int min_pwm, int tolerance) {
  // // PI Controller
  // // time difference
  // long currT = micros();
